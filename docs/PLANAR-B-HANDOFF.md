...
**Post-handoff repository update (2026-09-14):** The preceding sentence records the checkout **at that handoff**. PLANAR-B was later committed and pushed; verified current local `main` HEAD tracking `origin/main` is `6aa4763b3a2f6c1ab1c36694c37e3030bd9c3e58` (`Add Planar B output workflow and runtime smoke coverage`). This documentation-correction turn starts at that HEAD with only the untracked [9B-C1 probe](BLOCK-9B-C1-PROBE.md). The practical FRONT/BACK PASS above is unchanged.
