...
assert.match(rendererSource, /RUN TEST BAKE|runBlock6AProjectionBake/);
...
assert.match(runtimeSource, /Block6A_Source_3000x3840\.png/);
assert.match(runtimeSource, /Block6A_CanonicalBake_4728x5760\.png/);
assert.match(runtimeSource, /Block6A_Reprojected_3000x3840\.png/);
...
assert.match(rendererSource, /projectionBake:[\s\S]*?userValidation: 'PASS_CLOSED'/);
assert.match(rendererSource, /Block 6A CLOSED/);
...
assert.match(mainSource, /block6a-source-preview\.png/);
