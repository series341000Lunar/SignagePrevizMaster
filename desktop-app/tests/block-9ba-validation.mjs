...
assert.match(renderer, /binding\.mesh\.userData\.productionHelper === true/);
assert.match(renderer, /if \(material\.map !== desiredMap\)/);
...
console.log('BLOCK9BA_PREVIEW_MODE_SESSION_ONLY=true');
